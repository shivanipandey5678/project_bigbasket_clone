...
sortdiscountHighToLow_select.addEventListener('change',function(){
   ...
   console.log(maindata)
    if (sortdiscountHighToLow_select_value == 10) { 
        let arr = maindata.filter(obj=>obj.sale < 10 && obj.sale > 0);
        ...
        let arr = maindata.filter(obj=>obj.sale  >= 10  && obj.sale  <20);
            
            // return obj.sale >= 10 && obj.sale < 20;
   
       
        productsDiv.innerHTML="";
        displayproducts(arr)
    } else if (sortdiscountHighToLow_select_value == 30) { 
        let arr = maindata.filter(obj=>obj.sale  >= 20  && obj.sale  <30);
       
        productsDiv.innerHTML="";
        displayproducts(arr)
    } else if (sortdiscountHighToLow_select_value == 40) { 
        let arr = maindata.filter(obj=>obj.sale  >=30  && obj.sale  <40);
       
        productsDiv.innerHTML="";
        displayproducts(arr)
    } else if (sortdiscountHighToLow_select_value == 50) { 
        let arr = maindata.filter(obj=>obj.sale  >= 40  );
